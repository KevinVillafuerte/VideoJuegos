...
public class GameManagerX : MonoBehaviour
{
    ...
    {
        score += scoreToAdd;
        scoreText.text = "Score: " + scoreToAdd;//Se añade la puntuacion para que de esta manera salga en la pantalla
    }
    ...
    public void GameOver()
    {
        ...
        restartButton.gameObject.SetActive(true);//Se pone en true para que salga el boton de reinicio
        isGameActive = false;
    }
